...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><img class="logo-img" src="../images/tblogo.png" alt="logo"></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form action="login.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="custom-control">
                            <span class="custom-control-label"><?php echo $message;?></span>
                        </label>
                    </div>
