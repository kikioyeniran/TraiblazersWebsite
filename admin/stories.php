...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO stories(name,testimony,picture,portfolio) Values ('$name', '$testimony', '$image', '$portfolio')";
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <p class="pageheader-text">Insert and Edit Stories in Trail Blazers.</p>
                    ...
                    <div class="row">
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">New stories</h5>
                                    <div class="card-body">
                    ...
                    <?php
                        ...
                        {?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div>
                                    <a href = "edit.php?story=<?php echo urlencode($row['id']); ?>"><img src='images/<?php echo $row['picture']?>' alt="user" class="rounded" width="100%"></a>
                                    </div>
                                </div>
                                ...
                                <a href = "delete.php?storyid=<?php echo  urlencode($row['id']); ?>" onclick="return confirm('Are you sure you want to delete this picture?');">Delete Post</a>
                                </div>
                            </div>
                            </div>
