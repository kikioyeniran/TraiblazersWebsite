...
?>
<section class="hero-wrap hero-wrap-2" style="background-image: url('admin/images/<?php echo $row['events']?>');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h2 class="mb-3 bread">Our Events</h2>
        ...
        <div class="row">
              	...
              	?>
				 	<div class="col-md-12 d-flex ftco-animate">
						<div class="blog-entry align-self-stretch d-md-flex">
							<a href="eventregistration.php?event=<?php echo urlencode($row['id']);?>" class="block-20" style="background-image: url('admin/images/<?php echo $row['picture']?>');">
							</a>
							<div class="text d-block pl-md-4">
								<div class="meta mb-3">
									<div><a href="#"><?php echo $date." ".$m_time; ?></a></div>
								</div>
								<h3 class="heading"><a href="#"><?php echo $row['theme']; ?></a></h3>
								<p><?php echo $row['about']; ?> </p>
								<p><a href="eventregistration.php?event=<?php echo urlencode($row['id']);?>&theme=<?php echo $row['theme']?>" class="btn btn-primary py-2 px-3">Register</a></p>
						</div>
		            </div>
		          </div>
				  <?php } ?>
          ...
          while($row = $result->fetch_assoc()){
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <p>"I know of no more encouraging fact than the unquestionable ability of man to elevate his life by conscious endeavour" - Henry David Thoreau</p>
            </div>
          </div>
